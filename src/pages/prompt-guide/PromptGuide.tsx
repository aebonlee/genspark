...
import superAgentPrompts from './data/super-agent-prompts';
import researchPrompts from './data/research-prompts';
import advanced from './data/advanced';

const SECTIONS = [basics, superAgentPrompts, researchPrompts, advanced];
...
export default function PromptGuide() {
  ...
  return (
    <div className="guide-page">
      <SEOHead title={isKo ? '프롬프트 가이드' : 'Prompt Guide'} path="/prompt-guide" />
