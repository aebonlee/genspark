...
const SECTIONS = [overview, webApps, github, examples];

export default function AIDeveloperGuide() {
  ...
  return (
    <div className="guide-page">
      <SEOHead title={isKo ? 'AI Developer 가이드' : 'AI Developer Guide'} path="/ai-developer" />
