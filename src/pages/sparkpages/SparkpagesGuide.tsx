...
import creating from './data/creating';
import customizing from './data/customizing';
import examples from './data/examples';

const SECTIONS = [overview, creating, customizing, examples];

export default function SparkpagesGuide() {
  ...
  return (
    <div className="guide-page">
      <SEOHead title={isKo ? 'Sparkpages 가이드' : 'Sparkpages Guide'} path="/sparkpages" />
