...
import imageGen from './data/image-gen';
import videoGen from './data/video-gen';
import phoneCalling from './data/phone-calling';
import documents from './data/documents';

const SECTIONS = [overview, imageGen, videoGen, phoneCalling, documents];
...
export default function AIToolsGuide() {
  ...
  return (
    <div className="guide-page">
      <SEOHead title={isKo ? 'AI Tools 가이드' : 'AI Tools Guide'} path="/ai-tools" />
