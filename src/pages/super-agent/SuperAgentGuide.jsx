...
const SECTIONS = [overview, research, automation, productivity, bestPractices];

export default function SuperAgentGuide() {
  ...
  return (
    <div className="guide-page">
      <SEOHead title={isKo ? 'Super Agent 가이드' : 'Super Agent Guide'} path="/super-agent" />
